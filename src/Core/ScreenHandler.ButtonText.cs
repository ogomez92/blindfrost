...
{
    /// <summary>
    /// Turning an on-screen button into something worth speaking: the known-name
    /// table for icon-only buttons, the cascade that mines a label out of text,
    /// hierarchy, sprites and components, and the name cleanup helpers.
    /// </summary>
