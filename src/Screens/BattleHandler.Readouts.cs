...
{
    /// <summary>
    /// The nine on-demand readout keys: hand, board, waves, bell, modifiers,
    /// gold and turn, plus the Ctrl-key roll calls for one side's counters
    /// and health. Also holds the hand count and wave-countdown text they
    /// share with the screen announcement.
    /// </summary>
    public partial class BattleHandler
    {
        ...
        // ---- Roll calls for one side (Ctrl keys) -----------------------------
