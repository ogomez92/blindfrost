...
{
    /// <summary>
    /// The Spanish part of the screen handler string table: Town, ContinueRun,
    ...
    public static partial class Loc
    {
        private static void RegisterHandlerStringsSpanish()
        {
            ...
            Add("es", "tutorial_counter_keys_hint", "No hace falta seguir los contadores carta por carta: pulsa Ctrl C para oir cada una de tus unidades y en cuantos turnos actua, y Ctrl Mayus C para lo mismo en el lado enemigo.");
