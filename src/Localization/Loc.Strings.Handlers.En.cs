namespace WildfrostAccessibility
{
    ...
    public static partial class Loc
    {
        private static void RegisterHandlerStringsEnglish()
        {
            ...
            Add("en", "tutorial_counter_keys_hint", "You do not have to track the counters one card at a time: press Control C to hear each of your units and how many turns until it acts, and Control Shift C for the same on the enemy side.");
