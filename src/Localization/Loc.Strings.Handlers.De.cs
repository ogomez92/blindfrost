namespace WildfrostAccessibility
{
    ...
    public static partial class Loc
    {
        private static void RegisterHandlerStringsGerman()
        {
            ...
            Add("de", "tutorial_counter_keys_hint", "Du musst die Zaehler nicht Karte fuer Karte verfolgen: Strg C nennt jede deiner Einheiten und in wie vielen Runden sie handelt, Strg Umschalt C dasselbe fuer die Gegner.");
